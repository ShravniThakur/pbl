...
const Dashboard = () => {
    ...
    const statCards = useMemo(() => [
        ...
        { label: 'Total Checks', value: totalChecks, sub: 'Eligibility checks run', color: 'text-accentSoft' },
        { label: 'Approved', value: approvedChecks, sub: 'Checks eligible', color: 'text-success' },
        { label: 'Rejected', value: rejectedChecks, sub: 'Checks not eligible', color: 'text-danger' },
    ...
    // SAFE ACCESS: Get first name without crashing if user is null
                        ...
                        {recentChecks.map((c) => (
                            ...
                            >
                                ...
                                <div className="hidden md:grid grid-cols-[1.5fr_1fr_1fr_1fr_1fr] gap-3 p-3 text-sm items-center">
                                    <p className="font-semibold text-heading">{c?.loanType || 'N/A'}</p>
                                ...
                                <div className="md:hidden px-4 py-3 flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-sm text-bodyText/60">
                                            {fmt(c?.requestedLoanAmount)} · {c?.createdAt ? new Date(c.createdAt).toLocaleDateString('en-IN') : ''}
                                        </p>
                                    </div>
