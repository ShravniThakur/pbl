            ...
            <div className="w-full max-w-[420px] flex flex-col items-center gap-8 relative z-10 animate-fade-up">
                ...
                <div className="w-full flex flex-col items-center text-center gap-3">
                    ...
                    <div className="flex flex-col gap-1.5">
                        <h1 className="text-[40px] font-black text-sidebar-bg tracking-[-0.03em] leading-none py-4">Create account</h1>
                        <p className="text-[14px] font-medium text-text-muted">Start checking your loan eligibility for free</p>
                    </div>
                </div>
                ...
                <div className="w-full bg-surface border border-border-default rounded-[16px] p-8 sm:p-10 shadow-card">
                    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="text-[12px] font-bold text-text-primary uppercase tracking-[0.05em]">Full Name</label>
                            <input
                ...
                <div className="flex flex-col items-center gap-6 w-full">
                    ...
                    <div className="flex items-center gap-2 text-[11px] font-bold text-text-muted/60 uppercase tracking-widest">
                        <Lock size={12} /> Secure Sign Up Area
                    </div>
                </div>
